...
public class Neuro extends Funcionario {
    ...
    public Neuro(String idFuncionario, String nome, Boolean isAdmin, TipoPessoaEnum tipoPessoaEnum, String especialidade){
    ...
    public String diagnostico(List<String> sintomas, Paciente paciente) {
        System.out.println("Dados os sintomas: " + sintomas + " do paciente: " + paciente.getNome() + " o diagnóstico é de TDAH");
        return "TDAH";
    }
}
